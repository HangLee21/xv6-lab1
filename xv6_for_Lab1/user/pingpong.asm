...
int main(int argc, char *argv[])
{
  ...
  10:	3d4080e7          	jalr	980(ra) # 3e0 <pipe>
  pipe(p2);
  14:	fe040513          	addi	a0,s0,-32
  18:	00000097          	auipc	ra,0x0
  1c:	3c8080e7          	jalr	968(ra) # 3e0 <pipe>
  char c[1];
  int pid = fork();
  20:	00000097          	auipc	ra,0x0
  24:	3a8080e7          	jalr	936(ra) # 3c8 <fork>
  // parent
  if(pid > 0){
  28:	08a04163          	bgtz	a0,aa <main+0xaa>
    close(p1[1]);
    close(p2[0]);
    exit(0);
  } 
  ...
  2c:	ed6d                	bnez	a0,126 <main+0x126>
    close(p1[1]);
  2e:	fec42503          	lw	a0,-20(s0)
  32:	00000097          	auipc	ra,0x0
  36:	3c6080e7          	jalr	966(ra) # 3f8 <close>
    close(p2[0]);
  3a:	fe042503          	lw	a0,-32(s0)
  3e:	00000097          	auipc	ra,0x0
  42:	3ba080e7          	jalr	954(ra) # 3f8 <close>
    read(p1[0], c, sizeof c);
  46:	4605                	li	a2,1
  48:	fd840593          	addi	a1,s0,-40
  4c:	fe842503          	lw	a0,-24(s0)
  50:	00000097          	auipc	ra,0x0
  54:	398080e7          	jalr	920(ra) # 3e8 <read>
    printf("%d: received ping\n",getpid());
  58:	00000097          	auipc	ra,0x0
  5c:	3f8080e7          	jalr	1016(ra) # 450 <getpid>
  60:	85aa                	mv	a1,a0
  62:	00001517          	auipc	a0,0x1
  66:	8ae50513          	addi	a0,a0,-1874 # 910 <malloc+0x10a>
  6a:	00000097          	auipc	ra,0x0
  6e:	6de080e7          	jalr	1758(ra) # 748 <printf>
    write(p2[1], " ", 1);
  72:	4605                	li	a2,1
  74:	00001597          	auipc	a1,0x1
  78:	87c58593          	addi	a1,a1,-1924 # 8f0 <malloc+0xea>
  7c:	fe442503          	lw	a0,-28(s0)
  80:	00000097          	auipc	ra,0x0
  84:	370080e7          	jalr	880(ra) # 3f0 <write>
    close(p1[0]);
  88:	fe842503          	lw	a0,-24(s0)
  8c:	00000097          	auipc	ra,0x0
  90:	36c080e7          	jalr	876(ra) # 3f8 <close>
    close(p2[1]);
  94:	fe442503          	lw	a0,-28(s0)
  98:	00000097          	auipc	ra,0x0
  9c:	360080e7          	jalr	864(ra) # 3f8 <close>
    exit(0);
  a0:	4501                	li	a0,0
  ...
  be:	33e080e7          	jalr	830(ra) # 3f8 <close>
    write(p1[1], " ", 1);
  c2:	4605                	li	a2,1
  c4:	00001597          	auipc	a1,0x1
  c8:	82c58593          	addi	a1,a1,-2004 # 8f0 <malloc+0xea>
  cc:	fec42503          	lw	a0,-20(s0)
  d0:	00000097          	auipc	ra,0x0
  d4:	320080e7          	jalr	800(ra) # 3f0 <write>
    read(p2[0], c, sizeof c);
  d8:	4605                	li	a2,1
  da:	fd840593          	addi	a1,s0,-40
  de:	fe042503          	lw	a0,-32(s0)
  e2:	00000097          	auipc	ra,0x0
  e6:	306080e7          	jalr	774(ra) # 3e8 <read>
    printf("%d: received pong\n",getpid());
  ea:	00000097          	auipc	ra,0x0
  ee:	366080e7          	jalr	870(ra) # 450 <getpid>
  f2:	85aa                	mv	a1,a0
  f4:	00001517          	auipc	a0,0x1
  f8:	80450513          	addi	a0,a0,-2044 # 8f8 <malloc+0xf2>
  fc:	00000097          	auipc	ra,0x0
 100:	64c080e7          	jalr	1612(ra) # 748 <printf>
    close(p1[1]);
 104:	fec42503          	lw	a0,-20(s0)
 108:	00000097          	auipc	ra,0x0
 10c:	2f0080e7          	jalr	752(ra) # 3f8 <close>
    close(p2[0]);
 ...
 122:	2b2080e7          	jalr	690(ra) # 3d0 <exit>
  } 
  // error
  else {
    printf("fork error\n");
 126:	00001517          	auipc	a0,0x1
 12a:	80250513          	addi	a0,a0,-2046 # 928 <malloc+0x122>
 12e:	00000097          	auipc	ra,0x0
 132:	61a080e7          	jalr	1562(ra) # 748 <printf>
    exit(-1);
 136:	557d                	li	a0,-1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b8:	48c50513          	addi	a0,a0,1164 # 940 <digits>
 4bc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 584:	3c0b8b93          	addi	s7,s7,960 # 940 <digits>
 ...
 6c4:	27890913          	addi	s2,s2,632 # 938 <malloc+0x132>
        while(*s != 0){
