...
int main(int argc, char *argv[])
{
  ...
  2e:	7c658593          	addi	a1,a1,1990 # 7f0 <malloc+0xe4>
  32:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3be:	44650513          	addi	a0,a0,1094 # 800 <digits>
 3c2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48a:	37ab8b93          	addi	s7,s7,890 # 800 <digits>
 ...
 5ca:	23290913          	addi	s2,s2,562 # 7f8 <malloc+0xec>
        while(*s != 0){
