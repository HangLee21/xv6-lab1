...
int main(int argc, char* argv[]){
 ...
 108:	fe090023          	sb	zero,-32(s2)
        args[j++] = ptr;
 10c:	00399793          	slli	a5,s3,0x3
 110:	fa040693          	addi	a3,s0,-96
 114:	97b6                	add	a5,a5,a3
 116:	efa7b023          	sd	s10,-288(a5)
        ptr = &buf[idx];
 11a:	f8040793          	addi	a5,s0,-128
 ...
 12e:	298080e7          	jalr	664(ra) # 3c2 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4aa:	44250513          	addi	a0,a0,1090 # 8e8 <digits>
 4ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 576:	376b8b93          	addi	s7,s7,886 # 8e8 <digits>
 ...
 6b6:	22e90913          	addi	s2,s2,558 # 8e0 <malloc+0xe8>
        while(*s != 0){
